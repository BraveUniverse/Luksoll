                ...
                if (receivedData.length >= 2) {
                    ...
                    try {
                        ...
                        if (/^(\[.*\]|\{.*\})\s*$/.test(key)) {
                            ...
                            if ((0, utils_1.isDataAuthentic)(value, urlDataWithHash.verification, mismatchedHashes)) {
                                return Object.assign(Object.assign({}, dataEntry), { value });
                            }
                            if ((0, utils_1.isDataAuthentic)(receivedData, urlDataWithHash.verification, mismatchedHashes)) {
                                return Object.assign(Object.assign({}, dataEntry), { value });
                            }
