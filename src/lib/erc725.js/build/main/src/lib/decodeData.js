...
exports.decodeTupleKeyValue = exports.isValidTuple = void 0;
...
function decodeKey(schema, value) {
    ...
    switch (lowerCaseKeyType) {
        case 'array': {
            ...
            if (typeof value === 'string' && (0, utils_1.countNumberOfBytes)(value) === 16) {
                return (0, utils_1.decodeKeyValue)('Number', 'uint128', value, schema.name) || 0;
            }
